...
final class VCardContactEncoder extends ContactEncoder {
    ...
    @Override
    public String[] encode(List<String> names, String organization, List<String> addresses,
        ...
        appendUpToUnique(newContents, newDisplayContents, "N", names, 1, null, fieldFormatter,
                TERMINATOR);
        ...
        return new String[] {
                newContents.toString(), newDisplayContents.toString()
        };
    }

    static List<Map<String, Set<String>>> buildPhoneMetadata(Collection<String> phones,
